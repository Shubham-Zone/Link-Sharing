...
const CardComponent = ({ img, user, name, createdBy, visibility, type }) => {
                ...
                <div className="col-md-8">
                    <div className="card-body">
                        ...
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col d-flex justify-content-center">
                                <div class="btn-group">
                                    {curUser === user && (<button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        Private
                                    </button>)}
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#">Menu item</a></li>
